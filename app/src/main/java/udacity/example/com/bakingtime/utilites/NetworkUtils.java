...
public class NetworkUtils {
     ...
     * ACHTUNG! FAKE METHOD
     *
     * This method returns the fake result from the HTTP response.
     *
     * @param url The URL to fetch the HTTP response from.
     * @return The contents of the FAKE HTTP response.
     */
    public static String getFakeResponseFromHttpUrl(URL url)  {
        String JsonString = "[\n" +
                "  {\n" +
                "    \"id\": 1,\n" +
                "    \"name\": \"Nutella Pie\",\n" +
